...
import org.recieverman.domains.EventParser;
...
import org.recieverman.domains.SupplierCatalog;
...
public class ReceiverMan {
  ...
  private void printRoutedFulfillment(
    ...
    out.println("TOKEN " + fulfillment.routeKey() + " " + token.token());
    router.verifier(fulfillment.routeKey())
        .filter(StreamingScenarioVerifier::complete)
